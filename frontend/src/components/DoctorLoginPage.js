      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-teal-600 via-emerald-600 to-green-700 p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <h1 className="text-4xl font-bold text-white mb-4">
            Smart Practice<br />Management
          </h1>
          <p className="text-xl text-white/80">
            Streamline your workflow with AI-powered assistance, integrated calendar, and patient communication tools.
          </p>
        </div>

        <div className="relative z-10 space-y-6">
          {[
            { icon: Brain, title: "AI Medical Assistant", desc: "Get intelligent help with daily tasks" },
            { icon: Calendar, title: "Google Calendar", desc: "Seamless appointment management" },
            { icon: Mail, title: "Gmail Integration", desc: "Send patient emails directly" },
          ].map((feature, i) => (
        ...
        <div className="w-full max-w-md">
          ...
          <Card className="p-6 sm:p-8 card-glow">
            ...
            <div className="text-center mb-8">
              <div className="w-14 h-14 mx-auto rounded-full bg-gradient-to-br from-teal-500 to-emerald-600 flex items-center justify-center mb-4">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button type="submit" disabled={loading} className="w-full h-11 btn-glow bg-gradient-to-r from-teal-600 to-emerald-600 hover:from-teal-700 hover:to-emerald-700">
                {loading
                  ? "Please wait..."
                  : isLogin
                  ? "Sign In"
